...
register_dtppodcontroller(py::module& m)
{
  ...
  py::class_<DTPPodController>(m, "DTPPodController")
    ...
    .def(
      "get_wibulator_node", &DTPPodController::get_wibulator_node, "i"_a, py::return_value_policy::reference_internal)
    .def("get_link_processor_node",
         &DTPPodController::get_link_processor_node,
         "i"_a,

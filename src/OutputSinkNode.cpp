...
void
OutputSinkNode::enable(bool dispatch) const
{
...
//-----------------------------------------------------------------------------
void
OutputSinkNode::disable(bool dispatch) const
{
...
//-----------------------------------------------------------------------------
void
OutputSinkNode::clear(bool dispatch) const
{
...
//-----------------------------------------------------------------------------
void
OutputSinkNode::drop_idles(bool dispatch) const
{
...
//-----------------------------------------------------------------------------
void
OutputSinkNode::keep_idles(bool dispatch) const
{

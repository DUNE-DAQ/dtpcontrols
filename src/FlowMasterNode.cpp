...
FlowMasterNode::FlowMasterNode(const uhal::Node& node)
  : uhal::Node(node)
{
}
...
void
FlowMasterNode::set_source_gbt(bool dispatch) const
{
...
void
FlowMasterNode::set_source_wtor(bool dispatch) const
{
...
uint32_t
FlowMasterNode::get_source() const
{
...
void
FlowMasterNode::set_sink_hits(bool dispatch) const
{
...
void
FlowMasterNode::set_sink_link(uint32_t link, bool dispatch) const
{
...
void
FlowMasterNode::set_outflow(uint32_t mode, bool dispatch) const
{

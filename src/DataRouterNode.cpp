...
DataRouterNode::DataRouterNode(const uhal::Node& node)
  : uhal::Node(node)
{
}
...
const DataReceptionNode&
DataRouterNode::get_data_reception_node(void) const
{
  return getNode<DataReceptionNode>("dr");
}

const DPRNode&
DataRouterNode::get_dpr_node(void) const
{

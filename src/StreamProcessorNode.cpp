...
StreamProcessorNode::StreamProcessorNode(const uhal::Node& node)
  : uhal::Node(node)
  , m_n_mon_probes(8)
{
  // FIXME
...
int
StreamProcessorNode::get_n_probes() const
{
...
void
StreamProcessorNode::drop_empty(bool drop, bool dispatch) const
{
...
void
StreamProcessorNode::set_threshold(const uint32_t threshold, bool dispatch) const
{
  ...
  } // placeholder for ERS error
}

uint32_t
StreamProcessorNode::get_threshold() const
{
...
uint64_t
StreamProcessorNode::get_channel_mask_all() const
{
...
void
StreamProcessorNode::set_channel_mask_all(uint64_t mask, bool dispatch) const
{
...
uint32_t
StreamProcessorNode::get_channel_mask(int channel) const
{
...
void
StreamProcessorNode::set_channel_mask(int channel, int mask) const
{
...
void
StreamProcessorNode::capture_pedestal(bool enable, bool dispatch) const
{

...
void StreamProcessorNode::set_mask_channel_00_to_31(const uint32_t mask00to31,
					       const bool dispatch,
...
void StreamProcessorNode::set_mask_channel_32_to_63(const uint32_t mask32to63,
					       const bool dispatch,
					       const bool mask_en_dsbl=true) {
  if (mask_en_dsbl){
...
void StreamProcessorNode::set_mask_channels(const uint64_t msb00to31_lsb31to64,
					  ...
					  const bool mask_en_dsbl=true) {
  if (mask_en_dsbl){
    set_mask_channel_32_to_63(msb00to31_lsb31to64, dispatch);
    set_mask_channel_00_to_31(msb00to31_lsb31to64 >> 32, dispatch);
  }
  else {
    set_mask_channel_32_to_63(~msb00to31_lsb31to64, dispatch);
    set_mask_channel_00_to_31(~msb00to31_lsb31to64 >> 32, dispatch);
...
const uhal::ValWord<uint32_t> StreamProcessorNode::get_mask_channel_00_to_31(const bool dispatch) {
  uhal::ValWord<uint32_t> m00To32 = getNode("csr.mask.ch-00-31").read();
  if(dispatch) {getClient().dispatch();}
  return m00To32;
}

const uhal::ValWord<uint32_t> StreamProcessorNode::get_mask_channel_32_to_63(const bool dispatch) {

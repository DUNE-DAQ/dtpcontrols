...
const DataRouterNode&
LinkProcessorNode::get_data_router_node() const
{
  return getNode<DataRouterNode>("drtr");
}

const StreamProcessorArrayNode&
LinkProcessorNode::get_stream_proc_array_node() const
{
  return getNode<StreamProcessorArrayNode>("stream_procs");
}

void
LinkProcessorNode::setup_dr(bool enable) const
{
...
void
LinkProcessorNode::drop_empty(bool drop) const
{
...
void
LinkProcessorNode::set_threshold(int stream, uint32_t threshold) const
{
...
uint32_t
LinkProcessorNode::get_threshold(int stream) const
{
  uint32_t strm = static_cast<uint32_t>(stream);
  auto l_strm_proc_arr_node = get_stream_proc_array_node();
  l_strm_proc_arr_node.stream_select(strm, false);
...
void
LinkProcessorNode::set_channel_mask(int stream, uint32_t channel, uint32_t mask) const
{
  uint32_t strm = static_cast<uint32_t>(stream);
  auto l_strm_proc_arr_node = get_stream_proc_array_node();
  l_strm_proc_arr_node.stream_select(strm, false);
...
uint32_t
LinkProcessorNode::get_channel_mask(int stream, uint32_t channel) const
{
  uint32_t strm = static_cast<uint32_t>(stream);
  auto l_strm_proc_arr_node = get_stream_proc_array_node();
  l_strm_proc_arr_node.stream_select(strm, false);
...
void
LinkProcessorNode::set_channel_mask_all(int stream, uint64_t mask) const
{
  uint32_t strm = static_cast<uint32_t>(stream);
  auto l_strm_proc_arr_node = get_stream_proc_array_node();
  l_strm_proc_arr_node.stream_select(strm, false);
...
uint64_t
LinkProcessorNode::get_channel_mask_all(int stream) const
{
  uint32_t strm = static_cast<uint32_t>(stream);
  auto l_strm_proc_arr_node = get_stream_proc_array_node();
  l_strm_proc_arr_node.stream_select(strm, false);
...
void
LinkProcessorNode::capture_pedestal(int stream, bool enable) const
{
  uint32_t strm = static_cast<uint32_t>(stream);
  auto l_strm_proc_arr_node = get_stream_proc_array_node();
  l_strm_proc_arr_node.stream_select(strm, false);
